...
export const HamburgerBG = styled.button`
  ...
  opacity: 0.5;
  z-index: 10;
  display: ${props => (props.activeDarkBackground ? 'block' : 'none')}
`;
...
export const TextRotate = styled(H1)`
...
export const ButtonBorder = styled.button`
  background-color: transparent;
  border: ${props => props.border ? `1pt solid ${Colors.black}` : `1pt solid transparent`};
  cursor: pointer;
  transition: ${Transitions.fastest};
  width: 100%;
...
export const InputCheckbox = styled.input`
  display: inline-block;
  height: ${props => props.size || '30pt'};
  width: ${props => props.size || '30pt'};
  vertical-align: top;
`;

export const ButtonBack = styled.button`
  background: url(../static/icons/back.png);
  background-size: cover;
  background-position: center;
  display: block;
  cursor: pointer;
