  ...
  <Layout hamburger>
    <S.LargeContainer>
      <S.GridLargeCard margin={`0 0 ${Spacing.lg} 0`}>
        ...
        <RegularBtn
          onClick={() => window.open('http://insagrado.sagrado.edu/robot/', '_blank')}
        >
          LEARN MORE
        </RegularBtn>
      </S.GridLargeCard>
      <S.GridLargeCard margin={`0 19pt ${Spacing.lg} 19pt`}>
        ...
        <RegularBtn
          onClick={() => window.open('http://insagrado.sagrado.edu/dracogme390/', '_blank')}
        >
          LEARN MORE
        </RegularBtn>
      </S.GridLargeCard>
      <S.GridLargeCard margin={`0 0 ${Spacing.lg} 0`}>
        ...
        <RegularBtn
          onClick={() => window.open('http://insagrado.sagrado.edu/empresarios/', '_blank')}
        >
          LEARN MORE
        </RegularBtn>
      </S.GridLargeCard>
      ...
      <S.GridLargeCard margin={`0 0 ${Spacing.lg} 0`}>
        ...
        <RegularBtn
          onClick={() => window.open('http://insagrado.sagrado.edu/innova/', '_blank')}
        >
          LEARN MORE
        </RegularBtn>
      </S.GridLargeCard>
      <S.GridLargeCard margin={`0 19pt ${Spacing.lg} 19pt`}>
        ...
        <RegularBtn
          onClick={() => window.open('http://insagrado.sagrado.edu/sagrado-inaugura-primer-centro-de-innovacion-colaborativa-en-puerto-rico/', '_blank')}
        >
          LEARN MORE
        </RegularBtn>
      </S.GridLargeCard>
